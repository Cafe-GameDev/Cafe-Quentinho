...
@warning_ignore("unused_signal")
signal current_game_state_updated(state_name: String) # Novo sinal para o estado atual do jogo
...
signal monitor_info_updated(monitor_str: String) # Novo sinal para informações do monitor
